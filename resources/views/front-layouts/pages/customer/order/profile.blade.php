    ...
    <div class="col-lg-5">
        <div class="service-view">
            <div class="service-header">
                ...
                <address class="service-location"><i class="fas fa-location-arrow"></i> {!! $lawyerProfile->address ?? 'Address not provided yet' !!}
                </address>
                <div class="rating">
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="card service-description">
                            <div class="card-body">
                                ...
                                <p class="mb-0">{!! $lawyerProfile->description ?? 'Lawyer have not provided any description' !!}</p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-lg-4 theiaStickySidebar">
        <div class="sidebar-widget widget">
            <div class="service-amount">
                <span>{!! $lawyerProfile->price ?? 'Rs.0' !!}</span>
            </div>
