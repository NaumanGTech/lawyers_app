                ...
                <div class="col-xl-8 offset-xl-2">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Form -->
                            <form class="" action="{{ route('category.store', $update_id) }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label>Category Name</label>
                                    <input type="text" name="title" value="<?=(isset($obj->title) && !empty($obj->title) ? $obj->title:'')?>" class="form-control" required placeholder="Type something"/>
                                </div>
                                <div class="form-group">
