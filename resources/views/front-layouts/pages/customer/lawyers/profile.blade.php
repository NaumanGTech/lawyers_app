    ...
    <div class="col-lg-5">
        <div class="service-view">
            <div class="service-header">
                ...
                <address class="service-location"><i class="fas fa-location-arrow"></i> Address</address>
                <div class="rating">
            ...
            <div class="service-images service-carousel">
                <div class="images-carousel owl-carousel owl-theme">
                    <div class="item">
                        <img src="{{ asset('front') }}/assets/img/services/service-02.jpg" alt="" class="img-fluid">
                    </div>
                    <div class="item">
                        <img src="{{ asset('front') }}/assets/img/services/service-02.jpg" alt="" class="img-fluid">
                    </div>
                ...
                <ul class="nav nav-pills service-tabs" id="pills-tab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
                            aria-controls="pills-profile" aria-selected="false">Services Offered</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <div class="card service-description">
                            <div class="card-body">
                                ...
                                <p class="mb-0">Car wash is a facility used to clean the exterior and, in some cases, the
                                    interior of motor vehicles. Car washes can be self-serve, fully automated, or
                                    full-service with attendants who wash the vehicle.</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="review-list">
                                    <div class="review-img">
                                        <img class="rounded-circle"
                                            src="{{ asset('front') }}/assets/img/customer/user-01.jpg" alt="">
                                    </div>
            ...
            <div class="popular-slider owl-carousel owl-theme">
                    ...
                    <div class="service-img">
                        <a href="service-details.html">
                            <img class="img-fluid serv-img" alt="Service Image"
                                src="{{ asset('front') }}/assets/img/services/service-03.jpg">
                        </a>
                        <div class="item-info">
                ...
                <div class="service-widget">
                    <div class="service-img">
                        <a href="service-details.html">
                            <img class="img-fluid serv-img" alt="Service Image"
                                src="{{ asset('front') }}/assets/img/services/service-04.jpg">
                        </a>
                        <div class="item-info">
                            <div class="service-user">
                                <a href="#">
                            ...
                            <div class="cate-list">
                                <a class="bg-yellow" href="service-details.html">Category</a>
                            </div>
                        </div>
                    </div>
                    <div class="service-content">
                        <h3 class="title">
                            <a href="service-details.html">{{ $lawyerProfile->name }}/a>
                        </h3>
                        <div class="rating">
                            <i class="fas fa-star"></i>
                            <i class="fas fa-star"></i>
                        ...
                        <div class="user-info">
                            <div class="row">
                                <span class="col-auto ser-contact"><i class="fas fa-phone me-1"></i>
                                    <span>{{ $lawyerProfile->phone }}</span></span>
                ...
                <div class="service-widget">
                    <div class="service-img">
                        <a href="service-details.html">
                            <img class="img-fluid serv-img" alt="Service Image"
                                src="{{ asset('front') }}/assets/img/services/service-05.jpg">
                        </a>
                        <div class="item-info">
                            <div class="service-user">
                                <a href="#">
                ...
                <div class="service-widget">
                    <div class="service-img">
                        <a href="service-details.html">
                            <img class="img-fluid serv-img" alt="Service Image"
                                src="{{ asset('front') }}/assets/img/services/service-06.jpg">
                        </a>
                        <div class="item-info">
                            <div class="service-user">
                                <a href="#">
                                    <img src="{{ asset('front') }}/assets/img/customer/user-06.jpg" alt="">
                                </a>
                                <span class="service-price">$100</span>
                            </div>
                            <div class="cate-list">
                ...
                <div class="service-widget">
                    <div class="service-img">
                        <a href="service-details.html">
                            <img class="img-fluid serv-img" alt="Service Image"
                                src="{{ asset('front') }}/assets/img/services/service-07.jpg">
                        </a>
                        <div class="item-info">
                            <div class="service-user">
                                <a href="#">
                                    <img src="{{ asset('front') }}/assets/img/customer/user-07.jpg" alt="">
                                </a>
                ...
                <div class="service-widget">
                    <div class="service-img">
                        <a href="service-details.html">
                            <img class="img-fluid serv-img" alt="Service Image"
                                src="{{ asset('front') }}/assets/img/services/service-08.jpg">
                        </a>
                        <div class="item-info">
                            <div class="service-user">
                                <a href="#">
                                    <img src="{{ asset('front') }}/assets/img/customer/user-08.jpg" alt="">
                                </a>
                                <span class="service-price">$100</span>
                            </div>
                            <div class="cate-list">
                ...
                <div class="service-widget">
                    <div class="service-img">
                        <a href="service-details.html">
                            <img class="img-fluid serv-img" alt="Service Image"
                                src="{{ asset('front') }}/assets/img/services/service-09.jpg">
                        </a>
                        <div class="item-info">
                            <div class="service-user">
                                <a href="#">
                                    <img src="{{ asset('front') }}/assets/img/customer/user-09.jpg" alt="">
                                </a>
                ...
                <div class="service-widget">
                    <div class="service-img">
                        <a href="service-details.html">
                            <img class="img-fluid serv-img" alt="Service Image"
                                src="{{ asset('front') }}/assets/img/services/service-10.jpg">
                        </a>
                        <div class="item-info">
                            <div class="service-user">
                                <a href="#">
                                    <img src="{{ asset('front') }}/assets/img/user.jpg" alt="">
                                </a>
            ...
            <div class="card-body">
                        ...
                        <div class="provider-img-wrap">
                            <a href="javascript:void(0);">
                                <img class="img-fluid rounded-circle" alt=""
                                    src="{{ asset('front') }}/assets/img/provider/provider-01.jpg">
                            </a>
                        </div>
                    </div>
                    <div class="provider-details">
                        <a href="javascript:void(0);" class="ser-provider-name">{{ $lawyerProfile->name }}</a>
                ...
                <div class="provider-info">
                    <p class="mb-1"><i class="far fa-envelope"></i> <a href="#"><span class="__cf_email__"
                                data-cfemail="dfabb7b0b2beacb7baada5bdbaadb89fbaa7beb2afb3baf1bcb0b2">[{{ $lawyerProfile->email }}&#160;protected]</span></a>
                    </p>
                    <p class="mb-0"><i class="fas fa-phone-alt"></i> {{ $lawyerProfile->phone}}</p>
                </div>
            </div>
        </div>
