                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-body pt-8">
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column font-weight-bold">
                                        <a href="#"
                                            class="text-dark-75 text-hover-primary mb-1 font-size-lg">Concept Design</a>
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column font-weight-bold">
                                        <a href="#"
                                            class="text-dark text-hover-primary mb-1 font-size-lg">Functional Logics</a>
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column font-weight-bold">
                                        <a href="#"
                                            class="text-dark text-hover-primary mb-1 font-size-lg">Development</a>
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <div class="d-flex flex-column font-weight-bold">
                                        <a href="#"
                                            class="text-dark text-hover-primary mb-1 font-size-lg">Testing</a>
                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            ...
                            <div class="card-body pt-2">
                                ...
                                <div class="d-flex align-items-center mb-10">
                                    ...
                                    <div class="d-flex flex-column flex-grow-1 font-weight-bold">
                                        <a href="#"
                                            class="text-dark text-hover-primary mb-1 font-size-lg">Kristaps Zumman</a>
                                        <span class="text-muted">PHP, SQLite, Artisan CLI</span>
                                    </div>
                                    <!--end::Text-->
                                    <!--begin::Dropdown-->
